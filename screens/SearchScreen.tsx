...
export const datas = [
  {
    ...
    shortDescription: 'Capital City of Nepal ',
    properties: [
      {
        id: '10',
        name: 'FabHotel Zeke',
        ...
        rating: 3.6,
        address:
          '346, Hennur Main Road, Post, Kalyan Nagar, 560043 Kathmandu, Nepal ',
        oldPrice: 4600,
        newPrice: 3312,
        latitude: '27.700769',
        longitude: '85.300140',
      ...
      },
      {
        ...
        name: 'Regenta Inn Indiranagar Kathmandu',
        rating: 4,
        address:
          ' 648/B, Regenta Inn Indiranagar, Binnamangala 1st stage Indiranagar, 560038 Kathmandu, Nepal',
        oldPrice: 4201,
        newPrice: 3327,
        latitude: '27.800769',
        longitude: '85.300140',
      ...
      {
        id: '12',
        name: 'Bloom Hotel - Kathmandu Airport',
        rating: 4.2,
        address:
          "Down Town Park, Sadahalli Gate, Tribhuvan Int'l Airport Rd, 562157 Kathmandu, Nepal",
        oldPrice: 3800,
        newPrice: 3078,
        latitude: '27.800769',
        longitude: '85.400140',
  ...
  },
  {
    ...
    shortDescription: 'Beautiful City in Nepal',
    properties: [
      {
        id: '20',
        ...
        rating: 3.5,
        address:
          'CFC-4/C, Road No-2 Hardware Park, Beside TCS, Tukkuguda, 501351 Pokhara, Nepal',
        oldPrice: 4332,
        newPrice: 3200,
        image:
      ...
      },
      {
        ...
        rating: 4.5,
        address:
          'Plot 73, Shilpi Valley, Gafoor Nagar, Madhapur, Opp Hitech City Mindspace, Pokhara',
        oldPrice: 5200,
        newPrice: 4100,
        image:
